...
#ifndef BOARD_VIEW_SDL_H_
#define BOARD_VIEW_SDL_H_
...
/**
 * Checks if the button replay is pressed or if the button quit is pressed
 * @retval true if replay button is pressed
 * @retval false if quit button is pressed
 */

extern bool replayGame(void);
