...
void BoardView_displayPlayersTurn (PieceType thisPlayer)
{
  switch (thisPlayer){
    ...
    case CROSS : printf("C'est au tour de joueur CROIX de jouer ! Placez votre pièce sous le format x,y\n\n"); break;

    case CIRCLE : printf("C'est au tour de joueur CERCLE de jouer ! Placez votre pièce sous le format x,y\n\n"); break;
